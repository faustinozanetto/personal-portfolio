    ...
    <React.Fragment>
      <FooterWrapper role='contentinfo'>
        <div class='footer__inner container container--full'>
          <FooterTop>
            <FooterBrand href='/en' aria-label='Go To Homepage'>
              <svg
            ...
            <FooterNav>
              <FooterNavList>
                ...
                <FooterNavItem>
                  <FooterNavLink to='/en/privacy-policy/'>
                    Privacy Policy
                  </FooterNavLink>
                </FooterNavItem>
                <FooterNavItem>
                  <FooterNavLink to='/en/terms-and-conditions/'>
                    Terms
                  </FooterNavLink>
                </FooterNavItem>
                <FooterNavItem>
                  <FooterNavLink to='/en/support-packages/'>
                    Support
                  </FooterNavLink>
                </FooterNavItem>
                <FooterNavItem>
                  <FooterNavLink to='/en/legal/'>Legal</FooterNavLink>
                </FooterNavItem>
              </FooterNavList>
            </FooterNav>
            <FooterSocial>
              <FooterSocial>
                <FooterSocialLink to='https://twitter.com/' title='Twitter'>
                  <TwitterIcon />
                </FooterSocialLink>
                <FooterSocialLink to='https://github.com/' title='Github'>
                  <GitHubIcon />
                </FooterSocialLink>
              </FooterSocial>
            </FooterSocial>
          ...
          <FooterBottom>
            <FooterCopyright>
              &copy; 2020 Retrosen. All rights reserved.<br></br>
            </FooterCopyright>
          </FooterBottom>
        </div>
      </FooterWrapper>
